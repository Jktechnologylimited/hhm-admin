...
export async function POST(req: NextRequest) {
  ...
  const t = await sql`INSERT INTO trainings (title,description,trainer,scheduled_at,zoom_link,zoom_password,is_published,max_attendees) VALUES (${title},${description},${trainer||'Evangelist Bob Pepple'},${scheduled_at},${zoom_link||null},${zoom_password||null},${is_published??true},${max_attendees||null}) RETURNING *`;
